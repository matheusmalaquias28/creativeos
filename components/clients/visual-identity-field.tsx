...
import { Loader2, Palette, RefreshCw, Sparkles, Trash2, Type, Wand2 } from "lucide-react";
...
type Props = {
  ...
  compact?: boolean;
  /** Em layout compacto, preview completo do DNA fica fora da coluna. */
            ...
            <div className="space-y-2 rounded-lg border border-border/50 bg-muted/30 p-3 text-sm">
              ...
              <div className="grid gap-1.5 text-[0.625rem] text-muted-foreground">
                <p className="flex items-start gap-1.5">
                  ...
                  <span>{local.visualIdentityDna.typography.headlineStyle}</span>
                </p>
                <p className="flex items-start gap-1.5">
...
/** Preview expandido do DNA — uso abaixo do grid de colunas. */
