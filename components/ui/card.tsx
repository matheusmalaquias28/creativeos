...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-5 overflow-hidden rounded-xl border border-border/50 bg-card/50 text-sm text-card-foreground backdrop-blur-md transition-premium hover:border-border/65",
